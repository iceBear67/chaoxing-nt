...
exports.countDeptPeople = exports.updateDeptSort = exports.deleteFollowerData = exports.insertFollowerData = exports.singleDeleteUserDeptData = exports.deleteUserDeptData = exports.getDeptUserDataByUid = exports.insertUserDeptData = exports.deleteUserByUid = exports.deleteUserData = exports.searchUser = exports.updateUsers = exports.deleteDeptUserByDeptid = exports.singleInsertUserData = exports.insertUserData = exports.getDeptData = exports.deleteDeptDataByDeptid = exports.deleteDeptData = exports.insertDeptData = exports.getUnitDataByFid = exports.getUnitData = exports.deleteAllUnitData = exports.updateUnitData = exports.insertUnitData = exports.init = void 0;
...
async function getUnitDataByFid(fid) {
    return await m_ContactUnitDb.queryFirst("fid=?", [fid]);
}
exports.getUnitDataByFid = getUnitDataByFid;
...
async function deleteDeptUserByDeptid(fid, deptid) {
    return await m_ContactsUserDeptDb.deleteData("fid=? and deptid=?", [
        fid,
        deptid,
    ]);
}
exports.deleteDeptUserByDeptid = deleteDeptUserByDeptid;
async function updateUsers(users) {
    for (let user of users) {
        let tempRes = await m_ContactsUserDb.insertOrUpdate(user, ["fid", "puid"]);
        if (!tempRes.success) {
            return tempRes;
        }
    }
...
//# sourceMappingURL=ContactsDbMainHelper.js.map