...
const { HmacSHA1 } = require("./cryptojs");
...
async function createQuery(query) {
  ...
  // 非必填参数
  query.hasOwnProperty("voice_format") &&
    (params["voice_format"] = query.voice_format);
  query.hasOwnProperty("hotword_id") &&
    (params["hotword_id"] = query.hotword_id);
  query.hasOwnProperty("needvad") && (params["needvad"] = query.needvad);
  query.hasOwnProperty("filter_dirty") &&
    (params["filter_dirty"] = query.filter_dirty);
  query.hasOwnProperty("filter_modal") &&
    (params["filter_modal"] = query.filter_modal);
  query.hasOwnProperty("filter_punc") &&
    (params["filter_punc"] = query.filter_punc);
  query.hasOwnProperty("convert_num_mode") &&
    (params["convert_num_mode"] = query.convert_num_mode);
  query.hasOwnProperty("word_info") && (params["word_info"] = query.word_info);
  query.hasOwnProperty("vad_silence_time") &&
    (params["vad_silence_time"] = query.vad_silence_time);
  query.hasOwnProperty("max_speak_time") &&
    (params["max_speak_time"] = query.max_speak_time);
...
module.exports = { guid, SpeechRecognizer };
