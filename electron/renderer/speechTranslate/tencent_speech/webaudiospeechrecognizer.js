const WebRecorder = require("./webrecorder");
const { SpeechRecognizer, guid } = require("./speechrecognizer");

class WebAudioSpeechRecognizer {
  constructor(params, deviceId, isLog) {
    this.params = params;
    this.recorder = null;
  ...
  start() {
    ...
    this.requestId = guid();
    this.recorder = new WebRecorder(this.requestId, this.deviceId, this.isLog);
...
module.exports = WebAudioSpeechRecognizer;
